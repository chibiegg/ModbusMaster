...
This function code is used to check the communication system between a master
device and a slave, or for checking various internal error conditions within a server.
...
@ingroup diagnostics
*/
uint8_t diagnostics(uint16_t u16WriteAddress, uint16_t u16WriteValue)
{
  _u16WriteAddress = u16WriteAddress;
  _u16WriteQty = 0;
  _u16TransmitBuffer[0] = u16WriteValue;
